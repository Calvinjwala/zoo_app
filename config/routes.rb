Rails.application.routes.draw do
  ...
  # post 'zoos/create' => 'zoos#create'

  # post 'animals/create' => 'animals#create'

  # patch 'animals/update' => 'animals#update'

  # patch 'zoos/update' => 'zoos#update'

  # delete 'zoos/destroy' => 'zoos#destroy'

  # delete 'animals/destroy' => 'animals#destroy'
